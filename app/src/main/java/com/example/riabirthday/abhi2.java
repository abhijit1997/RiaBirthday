...
public class abhi2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abhi2);


        final Button test = (Button) findViewById(R.id.abhi2);
    ...
    public void abhivoice2(View view) {

        Intent intent = new Intent(this, abhivoice2.class);
