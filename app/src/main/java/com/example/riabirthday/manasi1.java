...
public class manasi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manasi1);


        final Button test = (Button) findViewById(R.id.manasi1);
    ...
    public void ashray121(View view){

        Intent intent=new Intent(this,manasi2.class);
