...
public class harsh2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harsh2);


        final Button test = (Button) findViewById(R.id.harsh2);
    ...
    public void harsh3(View view) {

        Intent intent = new Intent(this, harsh3.class);
