...
public class bhabhi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhabhi1);




        final Button test = (Button) findViewById(R.id.kkr323);
    ...
    public void ashraysada(View view) {

        Intent intent = new Intent(this, bhabhivoice.class);
