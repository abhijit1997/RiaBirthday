...
public class dhruvi4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhruvi4);


        final Button test = (Button) findViewById(R.id.dhruvi4);
    ...
    public void dhruvivoice(View view) {

        Intent intent = new Intent(this, dhruvivoice.class);
