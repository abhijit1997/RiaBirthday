...
public class aayush4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aayush4);


        final Button test = (Button) findViewById(R.id.notpp1);
    ...
    public void aayuss1(View view) {

        Intent intent = new Intent(this, aayushvoicenote.class);
