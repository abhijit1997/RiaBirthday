...
public class aayush1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aayush1);


        final Button test = (Button) findViewById(R.id.aayu);
...
public void aayush(View view){

    Intent intent=new Intent(this,aayush2.class);
