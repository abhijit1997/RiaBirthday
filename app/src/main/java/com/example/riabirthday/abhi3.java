...
public class abhi3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abhi3);


        final Button test = (Button) findViewById(R.id.abhi3);
    ...
    public void abhivoice3(View view) {

        Intent intent = new Intent(this, abhivoice3.class);
