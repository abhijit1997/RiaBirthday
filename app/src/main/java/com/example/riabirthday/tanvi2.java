...
public class tanvi2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tanvi2);


        final Button test = (Button) findViewById(R.id.tanvivoice);
