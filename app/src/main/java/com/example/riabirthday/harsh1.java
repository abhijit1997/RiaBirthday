...
public class harsh1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harsh1);


        final Button test = (Button) findViewById(R.id.harsh1);
    ...
    public void harshvoice1(View view) {

        Intent intent = new Intent(this, harshvoice1.class);
