...
public class ashray1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ashray1);


        final Button test = (Button) findViewById(R.id.ashray1);
    ...
    public void ashray1(View view) {

        Intent intent = new Intent(this, ashray2.class);
