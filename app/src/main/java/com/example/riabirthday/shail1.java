...
public class shail1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shail1);


        final Button test = (Button) findViewById(R.id.aayu89);
    ...
    public void aayu198(View view) {

        Intent intent = new Intent(this, shailvoicenote.class);
