...
public class yogu3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yogu3);


        final Button test = (Button) findViewById(R.id.kkr32);
    ...
    public void yoguvoice(View view) {

        Intent intent = new Intent(this, yoguvoice.class);
