...
public class aayush2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aayush2);


        final Button test = (Button) findViewById(R.id.aayu2);
    ...
    public void aayu1(View view) {

        Intent intent = new Intent(this, aayush3.class);
