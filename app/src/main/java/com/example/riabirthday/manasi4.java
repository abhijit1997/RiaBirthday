...
public class manasi4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manasi4);


        final Button test = (Button) findViewById(R.id.manasi4);
    ...
    public void ashray21(View view) {

        Intent intent = new Intent(this, manasivoicenote.class);
