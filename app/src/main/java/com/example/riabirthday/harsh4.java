...
public class harsh4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_harsh4);


        final Button test = (Button) findViewById(R.id.harsh4);
    ...
    public void harshvoice3(View view) {

        Intent intent = new Intent(this, harshvoice3.class);
