...
public class yogu1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yogu1);


        final Button test = (Button) findViewById(R.id.yogu2);
    ...
    public void yogu2(View view) {

        Intent intent = new Intent(this, yogu2.class);
