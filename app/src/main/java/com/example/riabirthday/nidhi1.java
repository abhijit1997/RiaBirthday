...
public class nidhi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nidhi1);


        final Button test = (Button) findViewById(R.id.nidhivoice);
    ...
    public void nidhivoice(View view) {

        Intent intent = new Intent(this, nidhivoice.class);
