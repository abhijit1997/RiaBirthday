...
public class aayush3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aayush3);


        final Button test = (Button) findViewById(R.id.aayu3);
    ...
    public void aayuss(View view) {

        Intent intent = new Intent(this, aayush4.class);
