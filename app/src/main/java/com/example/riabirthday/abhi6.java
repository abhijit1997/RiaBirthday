...
public class abhi6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abhi6);


        final Button test = (Button) findViewById(R.id.abhi6);
    ...
    public void abhivoice6(View view) {

        Intent intent = new Intent(this, abhivoice6.class);
