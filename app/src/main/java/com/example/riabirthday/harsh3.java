...
public class harsh3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button test = (Button) findViewById(R.id.harsh3);
    ...
    public void harshvoice2(View view) {

        Intent intent = new Intent(this,harshvoice2.class);
