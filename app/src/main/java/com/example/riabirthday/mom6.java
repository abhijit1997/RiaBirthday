...
public class mom6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mom6);


        final Button test = (Button) findViewById(R.id.mom5);
    ...
    public void momvid(View view) {

        Intent intent = new Intent(this, momvid.class);
