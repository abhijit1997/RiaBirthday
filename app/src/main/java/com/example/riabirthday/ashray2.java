...
public class ashray2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ashray2);


        final Button test = (Button) findViewById(R.id.ashray2);
    ...
    public void ashray12(View view) {

        Intent intent = new Intent(this, ashrayvoicenote.class);
