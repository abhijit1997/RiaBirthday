...
public class gomi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gomi1);


        final Button test = (Button) findViewById(R.id.gomi1);
    ...
    public void gomivoicenote(View view){

        Intent intent=new Intent(this,gomivoicenote.class);
