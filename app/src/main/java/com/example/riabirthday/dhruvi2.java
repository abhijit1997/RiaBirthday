...
public class dhruvi2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhruvi2);


        final Button test = (Button) findViewById(R.id.dhruvi2);
    ...
    public void dhruvi3 (View view) {

        Intent intent = new Intent(this, dhruvi3.class);
