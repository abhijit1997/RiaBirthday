...
public class tanvi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tanvi1);


        final Button test = (Button) findViewById(R.id.tanvi2);
    ...
    public void tanvi2(View view) {

        Intent intent = new Intent(this, tanvi2.class);
