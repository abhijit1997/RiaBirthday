...
public class abhi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abhi1);


        final Button test = (Button) findViewById(R.id.abhi1);
    ...
    public void abhivoice1(View view) {

        Intent intent = new Intent(this, abhivoice.class);
