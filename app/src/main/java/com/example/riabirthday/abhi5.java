...
public class abhi5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abhi5);


        final Button test = (Button) findViewById(R.id.abhi5);
    ...
    public void abhivoice5(View view) {

        Intent intent = new Intent(this, abhivoice5.class);
