...
public class abhi4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abhi4);


        final Button test = (Button) findViewById(R.id.abhi4);
    ...
    public void abhivoice4(View view) {

        Intent intent = new Intent(this, abhivoice4.class);
