...
public class manasi2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manasi2);


        final Button test = (Button) findViewById(R.id.manasi2);
    ...
    public void ashray123(View view) {

        Intent intent = new Intent(this, manasi3.class);
