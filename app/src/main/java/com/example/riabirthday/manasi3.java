...
public class manasi3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manasi3);


        final Button test = (Button) findViewById(R.id.manasi3);
    ...
    public void ashray111(View view) {

        Intent intent = new Intent(this, manasi4.class);
