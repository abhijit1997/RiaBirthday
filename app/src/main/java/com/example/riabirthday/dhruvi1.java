...
public class dhruvi1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhruvi1);
    ...
    public void dhruvi2(View view) {

        Intent intent = new Intent(this, dhruvi2.class);
